...
const poekedex = [
    ...
    // ------------------------------------------
    { 
        id: 61, name: "Gatesaur", unit: 0, type: "Digital Logic", desc: "Emits logical signals (AND, OR, NOT) to process information.", 
        hp: 30, baseAtk: 6, basicAtkName: "Bit Shift",
        evolutions: [
            { reqXP: 10, name: "Ivysaur-Gate", desc: "Grew a massive universal gate on its back.", hpBonus: 12, atkBonus: 4, specialAtkName: "NAND Blast", specialAtkPower: 18 },
            { reqXP: 50, name: "Venugate", desc: "Can process millions of logic combinations instantly.", hpBonus: 25, atkBonus: 9, specialAtkName: "Universal Truth", specialAtkPower: 34 }
        ]
    },
    { 
